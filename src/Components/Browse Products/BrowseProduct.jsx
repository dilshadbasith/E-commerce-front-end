        ...
        >
          ...
          <div className="card2">
            <div className="flex justify-start items-center flex-col">
              <h2 className="text-4xl text-white pt-3 text-center pl-2 pr-2">
                {item.name}
              </h2>
            ...
            <div className="flex justify-around">
              <button className="bg-red-700 p-3 font-bold text-white rounded-xl flex items-center gap-1">
                <FaHeart />
                Add To Wishlist
              </button>
              <button
                onClick={AddtoCart}
                className="bg-blue-700 pt-3 pb-3 font-bold pl-5 pr-5 text-white rounded-xl flex items-center gap-1"
              >
                <FaCartShopping />
                Add To Cart
              </button>
