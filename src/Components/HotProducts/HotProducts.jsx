...
function HotProducts() {
  ...
  return (
    <div className="pt-10 pl-36 pb-10 pr-36">
      <h1 className="pb-5 text-4xl">Products</h1>
      <div className="flex">
      ...
      <div className=" w-[40rem] h-[30rem] border-2 border-gray-300">
        <div className="flex items-center justify-around flex-col gap-7 pt-3">
          ...
          <button className="bg-blue-500 text-white pt-3 pb-3 pl-8 pr-8 text-xs font-bold hover:bg-blue-700">ADD TO CART</button>
        </div>
      </div>

      <div className="flex  flex-wrap">
{hotProducts.map((item,index)=>(
      <div key={index} className=" w-[15rem] h-[15rem] border-2 border-gray-300">
        <div className="flex items-center justify-around flex-col gap-3 pt-3">
          <div>
            <img
              src={item.src}
              alt="image"
